...
>(({ className, ...props }, ref) => (
  <button
    ref={ref}
    className={cn(
      "absolute inset-y-0 z-20 hidden w-1 cursor ew-resize items-center bg-sidebar-foreground/10 transition-all hover:bg-sidebar-foreground/20 focus-visible:outline-none",
      className
    )}
    {...props}
  />
