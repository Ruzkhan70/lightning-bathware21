          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {contactInfo.map((info, index) => (
              <ScrollAnimation key={index} animation="slideUp" delay={index * 100}>
                <div className="bg-card rounded-lg shadow-lg p-6 text-center hover:shadow-xl hover:-translate-y-1 transition-all duration-300 h-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <ScrollAnimation animation="slideUp">
              <div className="bg-card rounded-lg shadow-lg p-8">
                <h2 className="text-2xl font-bold mb-6 text-foreground">{siteContent.contact.formTitle}</h2>
            ...
            <ScrollAnimation animation="slideUp" delay={100}>
              <div className="bg-card rounded-lg shadow-lg p-8">
                <h2 className="text-2xl font-bold mb-6 text-foreground">{siteContent.contact.findUsTitle || "Find Us"}</h2>
                ...
                {siteContent.contact.showFindUsSection !== false && (
                  <div className="space-y-4">
                    <h3 className="font-bold text-lg text-foreground">{siteContent.contact.storeLocationTitle}</h3>
                    <p className="text-muted-foreground">
                      {siteContent.contact.storeLocationDesc}
                    </p>
                    <div className="border-t border-border pt-4">
                      <h4 className="font-semibold text-foreground mb-2">{siteContent.contact.parkingTitle}</h4>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-6">
                {siteContent.faq.items.map((item, index) => (
                  <ScrollAnimation key={index} animation="slideUp" delay={index * 100}>
                    <div className={index < siteContent.faq.items.length - 1 ? "border-b border-border pb-6" : "pb-6"}>
