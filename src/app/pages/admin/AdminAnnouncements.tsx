  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Create and manage announcements for your customers</p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="grid lg:grid-cols-2 gap-8">
            ...
            <form onSubmit={(e) => handleSubmit(e, "publish")} className="space-y-6">
                      ...
                      >
                        ...
                        {badge && (
                          <span className={`text-xs px-2 py-0.5 rounded-full ${
                            badge.includes("✓") ? "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300" : "bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-300"
                          }`}>
                            {badge}
                          </span>
                        )}
              ...
              <div>
                ...
                <textarea
                  ...
                  className="mt-1 w-full px-3 py-2 border border-border rounded-lg focus:ring-2 focus:ring-[#D4AF37] focus:border-transparent resize-none"
                  rows={3}
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="mt-1 w-full px-3 py-2 border border-border rounded-lg focus:ring-2 focus:ring-[#D4AF37] focus:border-transparent"
                >
          ...
          <div className="space-y-6">
            ...
            {activeAnnouncement && (
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 dark:border-green-800 rounded-xl p-6">
                <div className="flex items-center gap-2 mb-4">
                  <div className="w-3 h-3 rounded-full bg-green-500 animate-pulse" />
                  <span className="text-green-700 dark:text-green-300 font-semibold">Currently Active</span>
                </div>
                ...
                <p className="text-muted-foreground mb-4">{activeAnnouncement.message}</p>
                ...
                <div className="flex gap-2 mt-4 pt-4 border-t border-green-200 dark:border-green-800">
                  <Button
                    size="sm"
                    variant="outline"
